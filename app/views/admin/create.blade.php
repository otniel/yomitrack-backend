                                ...
                                <div class="panel panel-primary">
                                    ...
                                    <div class="panel-body">
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    {{ Form::label('photo1', 'Foto 1', array('class' => 'awesome')) }}
                                                    {{ Form::file('photo1') }}
                                                    {{ $errors->first('photo1') }}
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    {{ Form::label('photo2', 'Foto 2', array('class' => 'awesome')) }}
                                                    {{ Form::file('photo2') }}
                                                    {{ $errors->first('photo2') }}
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    {{ Form::label('photo3', 'Foto 3', array('class' => 'awesome')) }}
                                                    {{ Form::file('photo3') }}
                                                    {{ $errors->first('photo3') }}
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    {{ Form::label('photo4', 'Foto 4', array('class' => 'awesome')) }}
                                                    {{ Form::file('photo4') }}
                                                    {{ $errors->first('photo4') }}
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    {{ Form::label('photo5', 'Foto 5', array('class' => 'awesome')) }}
                                                    {{ Form::file('photo5') }}
                                                    {{ $errors->first('photo5') }}
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <br/><br/>
                                        <button type="submit" class=" pull-right btn btn-default">{{ Lang::get('messages.save') }}</button>
                                    </div>
                                    </div>
                                    {{ Form::close() }}
                                </div>
